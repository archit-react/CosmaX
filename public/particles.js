...
// IMPORTANT: modified to be React/Vite-HMR friendly. Key changes:
// - window.pJSDom is never set to null; we clear it by length = 0
// - We always ensure window.pJSDom is an array before pushing
// - Safe guards around element lookups
/* -----------------------------------------------
...
var pJS = function (e, a) {
  ...
  this.pJS = {
    canvas: { el: t, w: t ? t.offsetWidth : 0, h: t ? t.offsetHeight : 0 },
    particles: {
  ...
  i.fn.canvasPaint = function () {
    if (i.canvas.ctx) i.canvas.ctx.fillRect(0, 0, i.canvas.w, i.canvas.h);
  };
  i.fn.canvasClear = function () {
    if (i.canvas.ctx) i.canvas.ctx.clearRect(0, 0, i.canvas.w, i.canvas.h);
  };
  ...
  i.fn.particle.prototype.draw = function () {
    var a = this,
      t = void 0 != a.radius_bubble ? a.radius_bubble : a.radius,
      s = void 0 != a.opacity_bubble ? a.opacity_bubble : a.opacity;
    var n = a.color.rgb
      ? "rgba(" +
        a.color.rgb.r +
        "," +
    ...
    switch (a.shape) {
      ...
      case "star":
        ...
        break;
      case "image":
        var r = "svg" == i.tmp.img_type ? a.img.obj : i.tmp.img_obj;
        if (r) {
  ...
  i.fn.particlesUpdate = function () {
    for (var e = 0; e < i.particles.array.length; e++) {
      ...
      if ("bounce" == i.particles.move.out_mode) {
  ...
  i.fn.vendors.eventsListeners = function () {
    i.interactivity.el =
      i.interactivity.detect_on === "window" ? window : i.canvas.el;
    if (
      i.interactivity.events.onhover.enable ||
      i.interactivity.events.onclick.enable
    ) {
          ...
          switch (i.interactivity.events.onclick.mode) {
            case "push":
              i.particles.move.enable
                ...
                ? i.fn.modes.pushParticles(1, i.interactivity.mouse)
                : i.interactivity.modes.push.particles_nb > 1 &&
                  i.fn.modes.pushParticles(
                    i.interactivity.modes.push.particles_nb
                  );
  ...
  i.fn.vendors.densityAutoParticles = function () {
    if (i.particles.number.density.enable && i.canvas.el) {
  ...
  i.fn.vendors.createSvgImg = function (e) {
    ...
    var n = new Blob([s], { type: "image/svg+xml;charset=utf-8" }),
  ...
  // MOD: don't set pJSDom to null—clear array instead (prevents push-of-null)
  ...
  i.fn.vendors.exportImg = function () {
    if (i.canvas.el) window.open(i.canvas.el.toDataURL("image/png"), "_blank");
  };
  ...
  i.fn.vendors.loadImg = function (e) {
    if (i.tmp.img_error === void 0 && "" != i.particles.shape.image.src) {
      if ("svg" == e) {
        ...
        a.onreadystatechange = function (s) {
          if (4 == a.readyState) {
            200 == a.status
              ? ((i.tmp.source_svg = s.currentTarget.response),
  ...
  i.fn.vendors.checkBeforeDraw = function () {
    if ("image" == i.particles.shape.type) {
      if ("svg" == i.tmp.img_type && void 0 == i.tmp.source_svg) {
...
// Global
window.pJSDom = Array.isArray(window.pJSDom) ? window.pJSDom : [];
...
window.particlesJS = function (e, a) {
  ...
  if (r) {
    ...
    window.pJSDom.push(new pJS(e, a));
  }
};
